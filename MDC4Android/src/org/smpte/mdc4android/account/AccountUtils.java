package org.smpte.mdc4android.account;
...
/**
 * A collection of authentication and account connection utilities. With strong
 * inspiration from the Google IO session app.
 * 
...
public class AccountUtils
{
    ...
    public static class UserProfile
    {
         ...
         * 
         * @param email the possible email address
         * @param is_primary whether the email address is the primary email
         *            address
         */
         ...
         * 
         * @param phone_number the possible phone number
         * @param is_primary whether the phone number is teh primary phone
         *            number
         */
    ...
    {
        return Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH ? getUserProfileOnIcsDevice(context) : getUserProfileOnGingerbreadDevice(context);
    }
     ...
     * Gingerbread devices.
     * 
     * @param context the context from which to retrieve the user's email
     *            address and name
    ...
    private static UserProfile getUserProfileOnIcsDevice(Context context)
    {
        ...
        ContactsContract.Contacts.Data.MIMETYPE + "=? OR " + ContactsContract.Contacts.Data.MIMETYPE + "=? OR " + ContactsContract.Contacts.Data.MIMETYPE + "=? OR " + ContactsContract.Contacts.Data.MIMETYPE + "=?", new String[] {ContactsContract.CommonDataKinds.Email.CONTENT_ITEM_TYPE,
                                                                                                                                                                                                                                     ContactsContract.CommonDataKinds.StructuredName.CONTENT_ITEM_TYPE,
                                                                                                                                                                                                                                     ContactsContract.CommonDataKinds.Phone.CONTENT_ITEM_TYPE,
                                                                                                                                                                                                                                     ContactsContract.CommonDataKinds.Photo.CONTENT_ITEM_TYPE},
        
        // Show primary rows first. Note that there won't be a primary email
        // address if the
