 ...
 * 
 */
@WebServiceClient(name = "DeviceService", targetNamespace = "http://www.smpte-ra.org/schemas/st2071/2014/mode", wsdlLocation = "file:/Users/Shared/DropBox/Dropbox/SMPTE/MDC/workspace/MDC/MDCF/src/main/xml/device.mode_services.wsdl")
    ...
    extends Service
{
    ...
    private final static QName DEVICESERVICE_QNAME = new QName("http://www.smpte-ra.org/schemas/st2071/2014/mode", "DeviceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/Users/Shared/DropBox/Dropbox/SMPTE/MDC/workspace/MDC/MDCF/src/main/xml/device.mode_services.wsdl");
    ...
    public ModeSupport getModeSupportPort() {
        return super.getPort(new QName("http://www.smpte-ra.org/schemas/st2071/2014/mode", "ModeSupportPort"), ModeSupport.class);
    }
    ...
    public ModeSupport getModeSupportPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.smpte-ra.org/schemas/st2071/2014/mode", "ModeSupportPort"), ModeSupport.class, features);
    }
