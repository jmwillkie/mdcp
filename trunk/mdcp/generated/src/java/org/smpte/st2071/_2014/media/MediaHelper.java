...
/**
* org/smpte/st2071/_2014/media/MediaHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from MDCF.idl
* Thursday, March 20, 2014 1:55:28 PM EDT
*/

abstract public class MediaHelper
{
  private static String  _id = "IDL:org/smpte/st2071/2014/media/Media:1.0";
    ...
    if (__typeCode == null)
    {
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          __typeCode = org.omg.CORBA.ORB.init ().create_value_tc (_id, "Media", org.omg.CORBA.VM_NONE.value, null, _members0);
          __active = false;
        }
      }
    }
  ...
  {
    return (org.smpte.st2071._2014.media.Media)((org.omg.CORBA_2_3.portable.InputStream) istream).read_value (id ());
  }
