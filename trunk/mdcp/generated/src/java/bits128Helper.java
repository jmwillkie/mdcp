...
abstract public class bits128Helper
{
  private static String  _id = "IDL:bits128:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_array_tc (16, __typeCode );
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (bits128Helper.id (), "bits128", __typeCode);
    }
    return __typeCode;
  }
