 ...
 * 
 */
@WebServiceClient(name = "DeviceService", targetNamespace = "http://www.smpte-ra.org/schemas/st2071/2014/device", wsdlLocation = "file:/Users/Shared/DropBox/Dropbox/SMPTE/MDC/workspace/MDC/MDCF/src/main/xml/device_services.wsdl")
    ...
    extends Service
{
    ...
    private final static QName DEVICESERVICE_QNAME = new QName("http://www.smpte-ra.org/schemas/st2071/2014/device", "DeviceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/Users/Shared/DropBox/Dropbox/SMPTE/MDC/workspace/MDC/MDCF/src/main/xml/device_services.wsdl");
    ...
    public Device getDevicePort() {
        return super.getPort(new QName("http://www.smpte-ra.org/schemas/st2071/2014/device", "DevicePort"), Device.class);
    }
    ...
    public Device getDevicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.smpte-ra.org/schemas/st2071/2014/device", "DevicePort"), Device.class, features);
    }
    ...
    public DeviceDirectory getDeviceDirectoryPort() {
        return super.getPort(new QName("http://www.smpte-ra.org/schemas/st2071/2014/device", "DeviceDirectoryPort"), DeviceDirectory.class);
    }
    ...
    public DeviceDirectory getDeviceDirectoryPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.smpte-ra.org/schemas/st2071/2014/device", "DeviceDirectoryPort"), DeviceDirectory.class, features);
    }
    ...
    public DeviceRegistry getDeviceRegistryPort() {
        return super.getPort(new QName("http://www.smpte-ra.org/schemas/st2071/2014/device", "DeviceRegistryPort"), DeviceRegistry.class);
    }
    ...
    public DeviceRegistry getDeviceRegistryPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.smpte-ra.org/schemas/st2071/2014/device", "DeviceRegistryPort"), DeviceRegistry.class, features);
    }
